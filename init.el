...
(custom-set-variables
 ...
 '(package-selected-packages
   '(web-mode use-package solarized-theme rainbow-delimiters prettier-js pdf-tools neotree markdown-preview-eww markdown-mode magit lispy js2-mode highlight-parentheses flycheck flucui-themes flex-autopair fcitx exec-path-from-shell emmet-mode edit-indirect color-theme-sanityinc-tomorrow cdlatex auto-complete-auctex auctex async)))
(custom-set-faces
